...
# local modules
from dataloader.h5dataset import SequenceDataset, H5Dataset, EventRecognition
...
class HDF5DataLoader(DataLoader):
    def __init__(self, dataloader_config):
        ...
        self.time_resolution = dataloader_config['time_resolution'] if 'time_resolution' in dataloader_config.keys() else None
